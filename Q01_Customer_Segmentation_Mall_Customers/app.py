...
CONFIG = {'title': 'Q1 Mall Customers - Hierarchical Clustering', 'data_file': 'Mall_Customers.csv', 'feature_cols': ['Age', 'Annual Income (k$)', 'Spending Score (1-100)'], 'drop_cols': ['CustomerID'], 'label_col': None, 'pipeline': 'default'}
