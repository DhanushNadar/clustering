...
CONFIG = {'title': 'Q19 Energy Consumption - Hierarchical Clustering', 'data_file': 'Energy_Consumption.csv', 'feature_cols': ['UsageHours', 'PowerConsumption', 'Devices'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
