...
CONFIG = {'title': 'Q15 Mobile Usage - Hierarchical Clustering', 'data_file': 'Mobile_Usage.csv', 'feature_cols': ['ScreenTime', 'AppUsage', 'DataUsage'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
