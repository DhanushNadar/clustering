...
CONFIG = {'title': 'Q14 Vehicle Usage - Hierarchical Clustering', 'data_file': 'Vehicle_Usage.csv', 'feature_cols': ['Distance', 'FuelUsage', 'Speed'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
