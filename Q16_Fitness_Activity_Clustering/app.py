...
CONFIG = {'title': 'Q16 Fitness Activity - Hierarchical Clustering', 'data_file': 'Fitness_Activity.csv', 'feature_cols': ['Steps', 'Calories', 'WorkoutTime'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
