...
CONFIG = {'title': 'Q4 Wine Data - Hierarchical Clustering', 'data_file': 'Wine.csv', 'feature_cols': ['Alcohol', 'Malic Acid', 'Ash', 'Magnesium'], 'drop_cols': [], 'label_col': 'Class', 'pipeline': 'default'}
