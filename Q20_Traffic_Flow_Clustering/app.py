...
CONFIG = {'title': 'Q20 Traffic Flow - Hierarchical Clustering', 'data_file': 'Traffic_Flow.csv', 'feature_cols': ['VehicleCount', 'Speed', 'Density'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
