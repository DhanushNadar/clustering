...
CONFIG = {'title': 'Q10 Telecom Customers - Hierarchical Clustering', 'data_file': 'Telecom_Customers.csv', 'feature_cols': ['tenure', 'MonthlyCharges', 'TotalCharges'], 'drop_cols': ['customerID', 'gender', 'Churn'], 'label_col': None, 'pipeline': 'telecom'}


def prepare_dataframe(df: pd.DataFrame) -> pd.DataFrame:
    if CONFIG["pipeline"] == "online_retail":
        df = df.copy()
