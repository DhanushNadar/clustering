...
CONFIG = {'title': 'Q3 Iris Flower - Hierarchical Clustering', 'data_file': 'Iris.csv', 'feature_cols': ['SepalLength', 'SepalWidth', 'PetalLength', 'PetalWidth'], 'drop_cols': [], 'label_col': 'Species', 'pipeline': 'default'}
