...
CONFIG = {'title': 'Q2 Wholesale Customers - Hierarchical Clustering', 'data_file': 'Wholesale_Customers.csv', 'feature_cols': ['Fresh', 'Milk', 'Grocery', 'Frozen', 'Detergents_Paper', 'Delicassen'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
