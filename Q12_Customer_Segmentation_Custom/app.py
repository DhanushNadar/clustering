...
CONFIG = {'title': 'Q12 Customer Segmentation - Hierarchical Clustering', 'data_file': 'Customer_Custom.csv', 'feature_cols': ['Age', 'Income', 'SpendingScore'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
