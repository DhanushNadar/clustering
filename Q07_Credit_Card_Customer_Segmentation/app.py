...
CONFIG = {'title': 'Q7 Credit Card Customers - Hierarchical Clustering', 'data_file': 'Credit_Card.csv', 'feature_cols': ['BALANCE', 'PURCHASES', 'CREDIT_LIMIT'], 'drop_cols': ['CUST_ID'], 'label_col': None, 'pipeline': 'default'}
