...
CONFIG = {'title': 'Q5 Social Network Users - Hierarchical Clustering', 'data_file': 'Social_Network_Ads.csv', 'feature_cols': ['Age', 'EstimatedSalary'], 'drop_cols': ['User ID', 'Gender', 'Purchased'], 'label_col': None, 'pipeline': 'default'}
