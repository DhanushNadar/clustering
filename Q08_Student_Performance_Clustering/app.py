...
CONFIG = {'title': 'Q8 Student Performance - Hierarchical Clustering', 'data_file': 'Student_Performance.csv', 'feature_cols': ['StudyHours', 'Attendance', 'Marks'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
