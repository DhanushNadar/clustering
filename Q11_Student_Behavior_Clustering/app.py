...
CONFIG = {'title': 'Q11 Student Behavior - Hierarchical Clustering', 'data_file': 'Student_Behavior.csv', 'feature_cols': ['StudyHours', 'Attendance', 'Marks'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
