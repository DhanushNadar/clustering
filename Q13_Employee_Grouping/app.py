...
CONFIG = {'title': 'Q13 Employee Grouping - Hierarchical Clustering', 'data_file': 'Employee_HR.csv', 'feature_cols': ['Experience', 'Salary', 'PerformanceScore'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
