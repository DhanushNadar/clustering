...
CONFIG = {'title': 'Q17 Learning Pattern - Hierarchical Clustering', 'data_file': 'Learning_Pattern.csv', 'feature_cols': ['TimeSpent', 'QuizScore', 'Assignments'], 'drop_cols': [], 'label_col': None, 'pipeline': 'default'}
